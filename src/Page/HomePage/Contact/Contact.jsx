...
const Contact = () => {
  return (
    <div className="grid grid-cols-2 items-center text-white mt-32 h-full ">
      ...
      <div >
          <form className="card-body w-10/12 mx-auto">
            ...
            <div className=" mt-6">
              <button className=" bg-[#d31c3e] hover:bg-white font-semibold duration-300 px-12 py-3 text-white hover:text-black rounded rounded-ss-xl uppercase rounded-ee-xl">Login</button>
            </div>
          </form>
      </div>
    </div>
